...
let s:subtle_black2   = { "gui": "#303030", "cterm": "none" }
let s:light_gray      = { "gui": "#B2B2B2", "cterm": "249" }
let s:lighter_gray    = { "gui": "#C6C6C6", "cterm": "251" }
let s:lighter_gray2   = { "gui": "#C6C6C6", "cterm": "none" }
...
if &background == "dark"
  ...
  let s:bg_very_subtle2 = s:subtle_black2
  let s:norm            = s:lighter_gray
  let s:norm2           = s:lighter_gray2
...
call s:h("CursorLineNr",  {"fg": s:blue, "bg": s:bg_very_subtle2})
...
call s:h("CursorLine",    {"fg": s:norm2, "bg": s:bg_very_subtle2})
